...
const Transformations = () => {
  ...
  // duplicate multiple times to ensure smooth looping
  const repeated = [...transformations, ...transformations, ...transformations];
    ...
    <section id="transformations" className="py-16 px-3 md:py-20 md:px-4 bg-black overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative w-full overflow-hidden">
          ...
          {/* continuous loop */}
          <div className="scroll-wrapper flex gap-4 animate-marquee will-change-transform">
            {repeated.map((t, i) => (
              <div
                key={`${t.id}-${i}`}
                className="flex-shrink-0 w-[200px] sm:w-[260px] md:w-[380px]"
              >
          ...
          {/* duplicate the scroll for seamless loop */}
          <div className="scroll-wrapper flex gap-4 animate-marquee2 will-change-transform absolute top-0">
            {repeated.map((t, i) => (
              <div
                key={`dupe-${t.id}-${i}`}
                className="flex-shrink-0 w-[200px] sm:w-[260px] md:w-[380px]"
